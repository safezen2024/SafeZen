  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-col4">
        ...
        Stay connected with us for updates and insights on emotional well-being.
        </p>
        ...
        <ul className="social-icons">
          ...
          <a href = "https://x.com/SafeZen2024?t=Pm33R4HNNUOT_5MWue8rTg&s=09" target="_blank">
          <FaXTwitter color="white" fontSize={"1.6rem"} />
          </a>
          <a href = "https://www.instagram.com/safezen2024/profilecard/?igsh=MW1kanNhM3MzazBrcA==" target="_blank">
